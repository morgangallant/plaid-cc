...
Credentials::Credentials(Enviroment env, const std::string &client_id,
  ...
  StatusWrapped<GetBalancesResponse> Client::GetBalancesWithOptions(
      const std::string &access_token, const GetBalancesOptions &options) {
    if (access_token == "")
  ...
  StatusWrapped<GetBalancesResponse> Client::GetBalances(
      const std::string &access_token) {
    return GetBalancesWithOptions(access_token, GetBalancesOptions());
  }

  StatusWrapped<GetAccountsResponse> Client::GetAccountsWithOptions(
      const std::string &access_token, const GetAccountsOptions &options) {
    if (access_token == "")
  ...
  StatusWrapped<GetAccountsResponse> Client::GetAccounts(
      const std::string &access_token) {
  ...
  StatusWrapped<GetAssetReportResponse> Client::GetAssetReport(
      const std::string &asset_report_token) {
  ...
  StatusWrapped<CreateAuditCopyTokenResponse> Client::CreateAuditCopy(
      const std::string &asset_report_token, const std::string &auditor_id) {
    if (asset_report_token == "")
  ...
  StatusWrapped<RemoveAssetReportResponse> Client::RemoveAssetReport(
      const std::string &asset_report_token) {
    if (asset_report_token == "")
  ...
  StatusWrapped<GetAuthResponse> Client::GetAuthWithOptions(
      const std::string &access_token, const GetAuthOptions &options) {
    if (access_token == "")
  ...
  StatusWrapped<GetAuthResponse> Client::GetAuth(
      const std::string &access_token) {
  ...
  StatusWrapped<GetHoldingsResponse> Client::GetHoldingsWithOptions(
      const std::string &access_token, const GetHoldingsOptions &options) {
    if (access_token == "")
  ...
  StatusWrapped<GetHoldingsResponse> Client::GetHoldings(
      const std::string &access_token) {
  ...
  StatusWrapped<GetIdentityResponse> Client::GetIdentity(
      const std::string &access_token) {
    if (access_token == "")
  ...
  StatusWrapped<GetIncomeResponse> Client::GetIncome(
      const std::string &access_token) {
    if (access_token == "")
  ...
  Client::GetInstitutionByIDWithOptions(
  ...
  StatusWrapped<GetInstitutionByIDResponse> Client::GetInstitutionByID(
      const std::string &id) {
    return GetInstitutionByIDWithOptions(id, GetInstitutionByIDOptions());
  }

  StatusWrapped<GetInstitutionsResponse> Client::GetInstitutionsWithOptions(
      int count, int offset, const GetInstitutionsOptions &options) {
    if (count == 0)
      count = 50;
    auto req = [&]() {
  ...
  Client::SearchInstitutionsWithOptions(
  ...
  StatusWrapped<SearchInstitutionsResponse> Client::SearchInstitutions(
      const std::string &query, const std::vector<std::string> &products) {
  ...
  StatusWrapped<GetItemResponse> Client::GetItem(
      const std::string &access_token) {}

  StatusWrapped<RemoveItemResponse> Client::RemoveItem(
      const std::string &access_token) {}

  StatusWrapped<UpdateItemWebhookResponse> Client::UpdateItemWebhook(
      const std::string &access_token, const std::string &webhook) {}

  StatusWrapped<InvalidateAccessTokenResponse> Client::InvalidateAccessToken(
      const std::string &access_token) {}

  StatusWrapped<UpdateAccessTokenVersionResponse>
  Client::UpdateAccessTokenVersion(const std::string &access_token) {}

  StatusWrapped<CreatePublicTokenResponse> Client::CreatePublicToken(
      const std::string &access_token) {}

  StatusWrapped<ExchangePublicTokenResponse> Client::ExchangePublicToken(
      const std::string &public_token) {}

  // Liabilities

  StatusWrapped<GetLiabilitiesResponse> Client::GetLiabilitiesWithOptions(
      const std::string &access_token, const GetLiabilitiesOptions &options) {}

  StatusWrapped<GetLiabilitiesResponse> Client::GetLiabilities(
      const std::string &access_token) {}

  // Payments

  StatusWrapped<CreatePaymentRecipientResponse>
  Client::Client::CreatePaymentRecipient(
      const std::string &name, const std::string &iban,
      const PaymentRecipientAddress &address) {}

  StatusWrapped<GetPaymentRecipientResponse> GetPaymentRecipient(
      const std::string &recipient_id) {}

  StatusWrapped<ListPaymentRecipientsResponse> Client::ListPaymentRecipients() {
  }

  StatusWrapped<CreatePaymentResponse> Client::CreatePayment(
      const std::string &recipient_id, const std::string &string,
      const PaymentAmount &amount) {}

  StatusWrapped<CreatePaymentTokenResponse> Client::CreatePaymentToken(
      const std::string &payment_id) {}

  StatusWrapped<GetPaymentResponse> Client::GetPayment(
      const std::string &payment_id) {}

  StatusWrapped<ListPaymentsResponse> Client::ListPayments(
      const ListPaymentsOptions &options) {}

  // Processors

  StatusWrapped<CreateProcessorTokenResponse> Client::CreateApexToken(
      const std::string &access_token, const std::string &account_id) {}

  StatusWrapped<CreateProcessorTokenResponse> Client::CreateDwollaToken(
      const std::string &access_token, const std::string &account_id) {}

  StatusWrapped<CreateProcessorTokenResponse> Client::CreateOcrolusToken(
      const std::string &access_token, const std::string &account_id) {}

  StatusWrapped<CreateStripeTokenResponse> Client::CreateStripeToken(
      const std::string &access_token, const std::string &account_id) {}
  ...
  StatusWrapped<ResetSandboxItemResponse> Client::ResetSandboxItem(
      const std::string &access_token) {}

  // Transactions

  StatusWrapped<GetTransactionsResponse> Client::GetTransactionsWithOptions(
      const std::string &access_token, const GetTransactionsOptions &options) {}

  StatusWrapped<GetTransactionsResponse> Client::GetTransactions(
      const std::string &access_token, const std::string &start_date,
